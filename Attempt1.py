...
##################################################################################
    ...
    #print('100 Entries for Attempt1 took {} seconds'.format(time.time() - starttime))
    #print('1000 Entries for Attempt1 took {} seconds'.format(time.time() - starttime))
    print('10000 Entries for Attempt1 took {} seconds'.format(time.time() - starttime))
